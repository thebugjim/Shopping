...
=======
        <button className="btn btn-lg btn-primary" style={{backgroundColor: '#FFBC00'}} type="submit" onClick={Parse.User.logOut}>Logout</button>
>>>>>>> be1b762628bb1f605a5455a0fc9e9824d062dd56
      </div>
    )
  }
});
